...
import type {ISearchResult, ISourceKey} from '../types';
import {
...
const mk = (source: ISourceKey, title: string): ISearchResult => ({source, title, url: `https://example.com/${encodeURIComponent(title)}`});
